...
const routes: RouteDef[] = [
  ...
  { pattern: '/crm', render: () => <ModuleGate module="crm" perm="crm.read"><CrmPage /></ModuleGate> },
  { pattern: '/crm/:tab', render: (p) => <ModuleGate module="crm" perm="crm.read"><CrmPage tab={p.tab} /></ModuleGate> },
  { pattern: '/companies', render: () => <ModuleGate module="crm" perm="crm.read"><CrmPage tab="companies" /></ModuleGate> },
  { pattern: '/companies/:id', render: (p) => <ModuleGate module="crm" perm="crm.read"><CompanyDetailPage id={p.id!} /></ModuleGate> },
  { pattern: '/leads', render: () => <ModuleGate module="crm" perm="crm.read"><CrmPage tab="leads" /></ModuleGate> },
  { pattern: '/leads/:id', render: (p) => <ModuleGate module="crm" perm="crm.read"><LeadDetailPage id={p.id!} /></ModuleGate> },
  { pattern: '/deals', render: () => <ModuleGate module="crm" perm="deals.read"><CrmPage tab="deals" /></ModuleGate> },
  { pattern: '/deals/:id', render: (p) => <ModuleGate module="crm" perm="deals.read"><DealDetailPage id={p.id!} /></ModuleGate> },
