...
/**
 * Column sort for a client-side table: first click ascending, second
 * descending, third back to the server's default order. Null when unsorted.
 */
...
/** A ranking map so statuses sort in funnel order, not alphabetically. */
