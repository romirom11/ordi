...
extendDict({
  en: {
    ...
    'crm.allCompanies': 'All companies',
...
extendDict({
  en: {
    ...
    'crm.exportLeads': 'Export',
    'crm.exportLeadsHint': 'Download the leads as a CSV spreadsheet – one row per lead, every field in its own column. The current filters apply.',
    'crm.exportFailed': 'Export failed',
    'crm.lead': 'Lead',
    'crm.score': 'Score',
    'crm.signal': 'Signal',
  ...
  uk: {
    ...
    'crm.exportLeads': 'Експорт',
    'crm.exportLeadsHint': 'Завантажити ліди таблицею CSV – один рядок на лід, кожне поле в окремій колонці. Поточні фільтри враховуються.',
    'crm.exportFailed': 'Не вдалося експортувати',
    'crm.lead': 'Лід',
    'crm.score': 'Оцінка',
    'crm.signal': 'Сигнал',
