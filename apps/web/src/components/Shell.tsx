...
const NAV_DEFS: NavDef[] = [
  ...
  // No perm: the directory is the workspace's own phone book – the API serves
  // a public slice to viewers without people.read.
  { key: 'people', to: '/people', labelKey: 'nav.people', icon: <Users size={16} />, section: 'operations', module: 'people' },
