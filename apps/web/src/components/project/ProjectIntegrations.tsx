...
extendDict({
  en: {
    ...
    'projects.slackDesc': 'Project events (tasks, assignments, status changes, comments, merged pull requests) are posted to this channel. Create an Incoming Webhook in Slack and paste the URL here.',
    'projects.slackSaved': 'Slack webhook saved',
    'projects.openSettings': 'Open Integrations',
    'projects.slackChannel': 'Channel',
    'projects.slackChannelDesc': 'Project events (tasks, assignments, status changes, comments, merged pull requests) are posted to this Slack channel.',
  ...
  uk: {
    ...
    'projects.slackDesc': 'Події проєкту (задачі, призначення, статуси, коментарі, змержені пулл-реквести) поститимуться в цей канал. Створіть Incoming Webhook у Slack і вставте URL сюди.',
    'projects.slackSaved': 'Вебхук Slack збережено',
    'projects.openSettings': 'Відкрити Інтеграції',
    'projects.slackChannel': 'Канал',
    'projects.slackChannelDesc': 'Події проєкту (задачі, призначення, статуси, коментарі, змержені пулл-реквести) поститимуться в цей канал Slack.',
