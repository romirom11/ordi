...
const EN: Dict = {
  ...
  'notify.sales.work_digest.body': '{overdue} overdue, {dueToday} due today, {waitingReply} awaiting reply, {nurtureDue} ready from nurture, and {noNextAction} without a next action.',
...
const UK: Dict = {
  ...
  'notify.sales.work_digest.body': 'Протерміновано: {overdue}, на сьогодні: {dueToday}, очікують відповіді: {waitingReply}, повернулись із відкладених: {nurtureDue}, без наступної дії: {noNextAction}.',
