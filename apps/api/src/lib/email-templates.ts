...
const EN: Dict = {
  ...
  'notify.comment.created.subject': 'New comment on {ref}',
  'notify.comment.created.heading': 'New comment',
  'notify.comment.created.body': '{actor} commented on {ref} “{title}”.',
  ...
  'notify.payment.recorded.subject': 'Payment recorded on invoice {ref}',
  'notify.payment.recorded.heading': 'Payment recorded',
  'notify.payment.recorded.body': '{actor} recorded a payment on invoice {ref}.',
  ...
  'notify.quote.declined.subject': 'Quote {ref} declined',
  'notify.quote.declined.heading': 'Quote declined',
  'notify.quote.declined.body': 'The client declined quote {ref}.',
  ...
  'notify.agent.run_finished.subject': '{actor} finished {ref}: {outcome}',
  'notify.agent.run_finished.heading': 'Agent run {outcome}',
  'notify.agent.run_finished.body': '{actor} finished working on {ref} “{title}” ({outcome}). {summary}',
  'notify.agent.needs_input.subject': '{actor} has a question on {ref}',
  'notify.agent.needs_input.heading': 'An agent needs your input',
  'notify.agent.needs_input.body': '{actor} paused on {ref} “{title}” and asked a question in the comments.',
  'notify.agent.credential_expiring.subject': 'Claude credential “{label}” expires soon',
  'notify.agent.credential_expiring.heading': 'A Claude credential expires soon',
  'notify.agent.credential_expiring.body': 'The credential “{label}” expires on {expiresAt}. Generate a new token and rotate it under Settings → Agents.',
  'notify.agent.credential_expired.subject': 'A Claude credential expired',
  'notify.agent.credential_expired.heading': 'A Claude credential expired',
  'notify.agent.credential_expired.body': 'Agents using it stop until it is rotated under Settings → Agents.',
...
const UK: Dict = {
  ...
  'notify.comment.created.subject': 'Новий коментар у {ref}',
  'notify.comment.created.heading': 'Новий коментар',
  'notify.comment.created.body': '{actor} залишив(ла) коментар у {ref} «{title}».',
  ...
  'notify.payment.recorded.subject': 'Зафіксовано оплату за рахунком {ref}',
  'notify.payment.recorded.heading': 'Зафіксовано оплату',
  'notify.payment.recorded.body': '{actor} зафіксував(ла) оплату за рахунком {ref}.',
  ...
  'notify.quote.declined.subject': 'Пропозицію {ref} відхилено',
  'notify.quote.declined.heading': 'Пропозицію відхилено',
  'notify.quote.declined.body': 'Клієнт відхилив пропозицію {ref}.',
  ...
  'notify.agent.run_finished.subject': '{actor} завершив {ref}: {outcome}',
  'notify.agent.run_finished.heading': 'Запуск агента: {outcome}',
  'notify.agent.run_finished.body': '{actor} завершив роботу над {ref} «{title}» ({outcome}). {summary}',
  'notify.agent.needs_input.subject': '{actor} має питання щодо {ref}',
  'notify.agent.needs_input.heading': 'Агенту потрібна ваша відповідь',
  'notify.agent.needs_input.body': '{actor} зупинився на {ref} «{title}» і поставив питання в коментарях.',
  'notify.agent.credential_expiring.subject': 'Креденшіал Claude «{label}» скоро закінчується',
  'notify.agent.credential_expiring.heading': 'Креденшіал Claude скоро закінчується',
  'notify.agent.credential_expiring.body': 'Креденшіал «{label}» діє до {expiresAt}. Згенеруйте новий токен і замініть його в Налаштування → Агенти.',
  'notify.agent.credential_expired.subject': 'Креденшіал Claude закінчився',
  'notify.agent.credential_expired.heading': 'Креденшіал Claude закінчився',
  'notify.agent.credential_expired.body': 'Агенти, що ним користуються, зупиняться, поки його не замінять у Налаштування → Агенти.',
