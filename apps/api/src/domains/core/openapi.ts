...
import {
  ...
  leadInputSchema, salesActivityInputSchema, researchImportSchema,
...
const ROWS: Row[] = [
  ...
  ['/sales-activities/{id}/complete', 'post', 'Complete activity and optionally schedule next', 'crm.write or deals.write', 'free', 'crm'],
