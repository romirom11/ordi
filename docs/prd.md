...
crm: companies (+overview), contacts, leads (+research import preview/commit, +convert), sales-work, sales-activities (+complete/+cancel), sales-message-templates, sales-sequences (+enroll/+stop), deals (+move, +demote-to-lead), deal-stages, notes.
