...
Overlay` і `decorations: true`). У нас вони на `{x:16, y:20}` – по центру
першого рядка сайдбару, тож перемикач воркспейсу стоїть **поруч** із ними
(відступ `pl-[84px]`), а не під порожньою смугою. Кнопки вікна, перемикач,
стрілки навігації і вкладки виходять в одному рядку.
