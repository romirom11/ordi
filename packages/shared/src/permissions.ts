...
export const PERMISSION_META: Record<Permission, { domain: PermissionDomain; label: string }> = {
  ...
  'projects.write': { domain: 'projects', label: 'Work in & manage every workspace project (project admin)' },
  ...
  'kb.write': { domain: 'kb', label: 'Create/edit pages in workspace spaces' },
  ...
  'people.read_documents': { domain: 'people', label: 'View employee documents (contracts, IDs)' },
